...
export const HeroAnimated = ({ title, subtitle }: Props) => {
    ...
    >
      <div className="flex w-full flex-col gap-y-2">
        ...
        >
          ...
          <ColorBar
            className="bg-gradient-purple-haze lg:block"
            width="w-10 md:w-16"
          />
        </motion.div>
        ...
        >
          ...
          <ColorBar className="bg-gradient-deep-sea" width="w-28 lg:w-40" />
          <ColorBar
        ...
        <motion.div
          className="ml-0 flex w-max items-center gap-x-2 md:ml-10"
          variants={itemVariants}
        >
          <ColorBar
            className="bg-gradient-electric-violet"
            width="w-28 md:w-32 lg:w-44"
          />
          ...
          <ColorBar
            ...
            width="w-32 md:w-56 lg:w-64"
          />
        </motion.div>

        <motion.div
          className="ml-0 flex w-full flex-col items-center py-5 md:ml-10 md:items-start"
          variants={itemVariants}
        >
          <motion.h1
            className="bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 bg-clip-text text-center text-[38px] leading-tight font-semibold tracking-normal text-wrap text-transparent md:text-left md:text-5xl lg:text-7xl"
          ...
          <motion.p
            className="text-center text-[22px] leading-relaxed font-semibold tracking-normal text-stone-600 md:text-2xl lg:text-3xl dark:text-stone-300"
