...
export const InputForm = ({ label, placeholder, type, name, id, disabled = false }: Props) => {
  ...
  return (
    <>
      ...
      >
        ...
        <input
          type={type}
          className="relative bg-[#0C0A09] z-10 flex h-12 text-sm md:text-base w-full border-none outline-none text-white/75 placeholder:text-white/50 rounded-lg px-3 py-2 disabled:cursor-not-allowed disabled:opacity-50"
          name={name}
          id={id}
