          ...
          <div className="w-full h-full flex flex-col items-center justify-center md:items-center md:flex-row lg:flex-col md:justify-center lg:justify-start">
            <div className="w-full flex flex-col items-center justify-center gap-y-2 lg:pt-6">
              ...
              <div className="flex items-center gap-x-2">
                ...
                />
                <p className="text-black/90 dark:text-white/90 text-xl md:text-2xl">Perú</p>
              </div>
              <p
                className={`text-lg leading-relaxed ${isActive ? "text-black/90 dark:text-white/90" : "text-black/75 dark:text-white/75"}  text-center text-pretty`}
              >
                {timeDifference}
              </p>
            </div>
            ...
            <div className="w-full flex flex-col items-center justify-end lg:justify-center">
              <div className="w-full h-max flex items-end justify-center gap-x-2">
                <span className="text-[#2563EB] text-center text-nowrap font-bold text-4xl md:text-5xl w-max">
                  {hours === 0 ? "00" : hours}:{minutes < 10 ? `0${minutes}` : minutes}
                </span>
                <span className={`text-base md:text-base lg:text-lg leading-relaxed ${isActive ? "text-black/90 dark:text-white/90" : "text-black/75 dark:text-white/75"} text-center text-pretty mb-0.5 md:mb-0.5 lg:mb-0.5`}>
                  UTC-5
                </span>
              </div>
              <p
                className={`text-base md:text-base lg:text-lg leading-relaxed ${isActive ? "text-black/90 dark:text-white/90" : "text-black/75 dark:text-white/75"} text-center text-pretty mt-2`}
              >
                {currentDate}
              </p>
            </div>
