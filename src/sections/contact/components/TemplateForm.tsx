import { AtSign, Mail, MessagesSquare, RefreshCw, Send, UserRoundCheck } from "lucide-react";
          ...
          <div className="w-full flex flex-col items-center justify-center space-y-6">
            ...
            >
              <ButtonComponent type="reset">
                ...
                <span className="text-base md:text-lg lg:text-xl font-medium">Reset</span>
              </ButtonComponent>
              <ButtonComponent type="submit">
                <Send className="w-5 h-5" />
                <span className="text-base md:text-lg lg:text-xl font-medium">Enviar</span>
              </ButtonComponent>
            </motion.div>
          </div>
        </motion.div>
