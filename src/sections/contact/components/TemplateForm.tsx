...
export const TemplateForm = () => {
  return (
    <div className='className="relative overflow-hidden w-full flex flex-col items-center justify-stretch rounded-3xl border border-gray-600/20 bg-[#F1F5F9] dark:bg-[#181818] transition-all duration-300 hover:shadow-xl'>
      <header className="relative w-full h-auto flex items-center justify-center mt-1 mb-6 border-b border-gray-600/20 py-4">
      ...
      <div className="px-6 md:px-6 lg:px-8 pb-6 md:pb-6 lg:pb-8 w-full h-full">
          ...
          <div className="w-full flex flex-col items-center justify-center space-y-6">
            <div className="w-full border-b border-gray-600/20">
              <div className="flex items-center px-1">
                <label
                  htmlFor="email"
                  className="text-black dark:text-white mr-2 min-w-[30px] text-base lg:text-lg font-medium"
                >
                  Correo Electrónico:
                </label>
                <input
                  ...
                  className="flex-grow bg-transparent text-stone-600 darktext-stone-400 placeholder:text-stone-500 px-2 py-1 text-base lg:text-base focus:outline-none focus:border-none autofill-custom-light dark:autofill-custom-dark"
                  required
                />
              </div>
            </div>
            ...
            <div className="w-full flex items-center justify-start py-6">
              <textarea
                ...
                className="w-full min-h-80 resize-none outline-none border-none p-6 rounded-xl bg-white/50 dark:bg-black shadow-lg shadow-white dark:shadow-black text-base lg:text-base font-normal text-pretty text-stone-800 dark:text-stone-400 dark:placeholder-stone-400 placeholder-stone-800"
              ></textarea>
            </div>
