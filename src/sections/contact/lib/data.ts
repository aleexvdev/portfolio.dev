...
export const socials: Social[] = [
  {
    id: 1,
    name: "Linkedin",
    path: "https://www.linkedin.com/in/alexvalverde/",
    icon_dark: "./images/social/linkedin.svg",
    icon_light: "./images/social/linkedin.svg"
  },
  {
    id: 2,
    name: "Instagram",
    path: "https://www.instagram.com/alexvalverde/",
    icon_dark: "./images/social/instagram_dark.svg",
    icon_light: "./images/social/instagram_light.svg"
  },
  {
    id: 3,
    name: "Discord",
    path: "https://discord.gg/8u9s7v9",
