export const AvailableToWork = () => {
  return (
    <div className="w-max h-full relative inline-flex overflow-hidden rounded-lg p-0.5">
      ...
      <div className="w-full h-full flex items-center justify-center space-x-3 backdrop-blur-3xl px-3 py-2 bg-[#F1F5F9] dark:bg-[#0C0A09] rounded-lg">
        ...
        <span className="inline-flex text-sm md:text-base lg:text-lg font-medium text-black dark:text-white text-nowrap">
